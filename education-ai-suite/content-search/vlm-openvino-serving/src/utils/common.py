...
class Settings(BaseSettings):
    ...
    http_proxy: Optional[str] = Field(default=None, json_schema_extra={"env": "http_proxy"})
    https_proxy: Optional[str] = Field(default=None, json_schema_extra={"env": "https_proxy"})
    no_proxy_env: Optional[str] = Field(default=None, json_schema_extra={"env": "no_proxy_env"})
