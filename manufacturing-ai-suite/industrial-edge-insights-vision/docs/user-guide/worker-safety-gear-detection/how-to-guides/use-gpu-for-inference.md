...
The pipeline `worker_safety_gear_detection_gpu` contains GPU specific elements and uses GPU backend for inferencing. We can start the pipeline as follows:
